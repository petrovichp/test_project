...
> - **Test 6 (retrain-with-mask) confirms the audit attribution is non-prescriptive.** Three fresh A2 policies trained from scratch with S6/S7/S10 masked during training+val are *strictly worse* than eval-only masking (Δ −1.64/−2.04/−3.17 vs −0.47/−1.39/−1.44). The masked strategies aren't redundant; they carry signal A2 depends on for context, even when individual contributions look marginal. Final verdict: **6 surfaced issues × 8 variants tested → 0 winners.**
